...
window.onload = function() {
    ...
    function init(gamelevel) {
        ...
        level = {
            ...
            height: 0,      // Height, gets calculated
            columns: 15,    // Number of tile columns
            rows: gamelevel,       // Number of tile rows
    ...
    function render() {
        ...
        if (gamestate == gamestates.gameover) {
           ...
           context.fillStyle = "#ffffff";
            context.font = "24px Verdana";
            drawCenterText("Get Life", level.x, level.y + level.height / 2 + 10, level.width);
           //drawCenterText("Click to start", level.x, level.y + level.height / 2 + 40, level.width);

            alert("Are you want to use your life ?");

            // if (confirm('Are you want to use your life ?')) {
            //     // Save it!
            //     window.location.href = "iap.html";
            //   } else {
            //     // Do nothing!
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Welcome Quick User ", 10, 37);
    ...
    // function api(){
    //  // rest api call for getting the level.
    //  // based on response call in it method.
    //  // level example 16
    //  gamelevel=10;
    //  bubblecolors=gamelevel/2;
    //  static 16 level 
    //  init(gamelevel);
    ...
    // 2.)  STE 2
    //gamelevel = gamlevel+1;

    // function updatelevel(gamelevel){
